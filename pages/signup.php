...
<header class="header">
    <div class="header-1">
        ...
        <div class="icons">
            ...
            <a href="signin.php" style="text-decoration: none; margin: 0 10px; padding: 10px 20px; border: 2px solid #3b5998; border-radius: 30px; transition: border-color 0.3s; background-color: #3b5998; color: #fff; font-size: 16px;">
                Sign in
            </a>
        </div>    
    </div>
